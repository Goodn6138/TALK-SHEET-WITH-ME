...
# # CORS configuration for Google Sheets and local testing
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=[
...
#     payload = {
#         "model": "command-xlarge-nightly",  # or "command-light" for faster responses
#         "prompt": prompt,
#         "max_tokens": 500,
#         "temperature": 0.3,
#         "stop_sequences": ["```", "---"]
...
#             raise HTTPException(status_code=502, detail="Cohere API error")
#         except Exception as e:
#             logger.error(f"Unexpected error calling Cohere: {str(e)}")
...
#     base_prompt = f"""
# You are an expert Google Apps Script developer. Convert the following natural language command into executable Google Apps Script code.

# RULES:
# 1. Return ONLY executable JavaScript code that works in Google Sheets environment
# 2. Use SpreadsheetApp and related Google Apps Script APIs
# 3. Handle errors gracefully with try-catch blocks
# 4. Include comments explaining major operations
# 5. Return data/results when appropriate
...
#             script=script,
#             explanation=f"Generated script for: {request.input}",
#             status="success"
#         )
...
#     import uvicorn
#     print("🚀 Starting Excel AI Backend...")
